...
## More details are provided in our paper:"http://ieeexplore.ieee.org/stamp/stamp.jsp?arnumber=7021050"
##
#
...
class LLDPSender (object):
  ...
  def add_switch (self, dpid, ports):
    ...
    ###new changes
    "all packets get the same port_num and port addr when created"
    port_num = 0
